...
public class Toss
{
	...
	public void toss(Map<String,String[]> hs,String[] team,int team1,int team2)
	{
...
//		team2=tp.team2;
		if(user==autoValue)
		{
			...
			if(playing==1)
			{
				...
				mat.firstInnings(tp.hs,tp.team1player,tp.team2player,team,team1,team2);
				System.out.println(team[team2-1]+" ==> BOWLING\n"+team[team1-1]+" ==> BATTING");
				mat.secondInnings(tp.hs,tp.team2player,tp.team1player,team,team2,team1);
				//mat.bowling(tp.team2player, team2);
				mat.winings(team1,team2);
			}
			else
			{
				System.out.println(team[team1-1]+" choose to Bowling\n"+team[team2-1]+" has to Batting");
				//mat.bowling(tp.team1player, team1);
				mat.firstInnings(tp.hs,tp.team2player,tp.team1player,team, team2,team1);
				System.out.println(team[team2-1]+" ==> Batting\n"+team[team1-1]+" ==> Bowling");
				mat.secondInnings(tp.hs,tp.team1player,tp.team2player,team,team1,team2);
				mat.winings(team1,team2);
			}
